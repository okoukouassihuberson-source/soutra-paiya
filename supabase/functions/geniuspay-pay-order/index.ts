...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // get_order_payment_info utilise auth.uid() → doit être appelée avec le
    // JWT de l'utilisateur, pas le service role. Cf. commentaire miroir
    // dans geniuspay-pay-booking pour l'explication.
