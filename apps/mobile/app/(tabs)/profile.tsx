    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      <ScrollView contentContainerStyle={{ paddingBottom: spacing['2xl'] }}>
        ...
        {/* Espace gérant — toujours visible : /pro guide vers "Créer mon
            établissement" si le user n'en possède pas encore. Auparavant
            filtré sur profile.role, mais un établissement créé via
            pro_create_venue (activation immédiate, migration 0061) ne
            change pas le rôle du créateur — seuls les flux de revendication
            (0039) et de promotion modérateur (0045) le font — donc ce filtre
