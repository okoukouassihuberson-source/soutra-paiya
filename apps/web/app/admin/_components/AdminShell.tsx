...
// Icône check pour l'onglet "Modération" (validation Pro).
...
export function AdminShell({
  ...
  const navItems = accessLevel === 'moderator' ? NAV_MODERATOR : NAV_ADMIN;
  const appLabel = accessLevel === 'moderator' ? 'Modération Pro' : 'Espace Admin';
